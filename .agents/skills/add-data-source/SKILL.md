...
description: Use when the user asks to pull new Tushare data, add a new database table, or register a new sync task or scheduler job.
---
...
文件: `scripts/pull_xxx.py`，用于手动/历史补数据。
