...
description: Use when the user reports missing data, stale sync, blank frontend panels, broken APIs, or incorrect database-backed displays.
---
...
- 检查 `/api/v1/feed/status`，确认 scheduler 是否运行
- 检查后端日志中 `sync:` 前缀的行
